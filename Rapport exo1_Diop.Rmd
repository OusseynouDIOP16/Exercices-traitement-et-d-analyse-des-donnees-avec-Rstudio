...
boxplot(df$salaire, main = "Distribution des salaires", ylab = "Salaire")
```{r}
# Création du boxplot
...
```{r}
table(df_Diop$age, df_Diop$genre)

kable(table(df_Diop$age), caption = "Tableau croisé des fréquences de la variable Age")
